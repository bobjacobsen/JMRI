 ...
 *
 * 1) reorderColumns - static convenience method for reodering table columns
 *
 * 2) Select All editing - when a text related cell is placed in editing mode
...
//
     ...
     */
    public ReorderableBeanTable(TableModel dm) {
        this(dm, null, null);
    }
     ...
     */
    public ReorderableBeanTable(TableModel dm, TableColumnModel cm) {
        this(dm, cm, null);
    }
     ...
     */
    public ReorderableBeanTable(TableModel dm, TableColumnModel cm, ListSelectionModel sm) {
        super(dm, cm, sm);
    }
     ...
     */
    public ReorderableBeanTable(int numRows, int numColumns) {
     ...
     * @param columnNames       names of each column
     */
    public ReorderableBeanTable(final Object[][] rowData, final Object[] columnNames) {
