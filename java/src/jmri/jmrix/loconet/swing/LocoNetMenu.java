...
import jmri.jmrix.loconet.accy7thgen.AccySeventhGenDiscoveryPanel;
...
public class LocoNetMenu extends JMenu {
    ...
    public LocoNetMenu(LocoNetSystemConnectionMemo memo) {
        ...
        panelItems.add(new LocoNetMenuItem("MenuItem7thGenAccy", AccySeventhGenDiscoveryPanel.class, true, true)); // NOI18N
        panelItems.add(null);
