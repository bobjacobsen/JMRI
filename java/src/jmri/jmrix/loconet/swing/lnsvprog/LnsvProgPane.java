...
/**
 * Frame for discovery and display of LocoNet LNSV boards.
 ...
 */
public class LnsvProgPane extends jmri.jmrix.loconet.swing.LnPanel implements LocoNetListener {
    ...
    protected LnsvProgTableModel moduleTableModel = null;
    ...
    private transient TableRowSorter<LnsvProgTableModel> sorter;
    ...
    public synchronized void initComponents(LocoNetSystemConnectionMemo memo) {
        ...
        moduleTableModel = new LnsvProgTableModel(this, memo);
...
//        add(holder, BorderLayout.LINE_START);
    ...
    private final static Logger log = LoggerFactory.getLogger(LnsvProgPane.class);
