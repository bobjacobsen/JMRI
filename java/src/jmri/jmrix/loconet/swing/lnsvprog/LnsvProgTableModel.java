...
/**
 * Table model for the programmed LNSV Modules table.
 *
 * @author Egbert Broerse Copyright (C) 2020
 * @author Bob Jacobsen  Copyright (C) 2023
 */
public class LnsvProgTableModel extends AbstractTableModel implements PropertyChangeListener, ProgrammingTool {
   ...
   public Object getValueAt(int r, int c) {
    ...
    private final static Logger log = LoggerFactory.getLogger(LnsvProgTableModel.class);
